...
#ifndef __EXAMPLE_TEST_1_H__
#define __EXAMPLE_TEST_1_H__
...
//typedef struct example_test_1_state {
//  struct psock p;
//  char inputbuffer[10];
//  char name[40];
//} uip_tcp_appstate_t;

typedef struct struct_example2_state {
enum {WELCOME_SENT, WELCOME_ACKED} state;
}example2_state;
/* Finally we define the application function to be called by uIP. */
void example_test_1_appcall(void);
#ifndef UIP_APPCALL
#define UIP_APPCALL example_test_1_appcall
#endif /* UIP_APPCALL */

void example_test_1_init(void);
